...
export async function generateMetadata({
  ...
  return {
    title: `${book.name} - NCERT Book | MscTutor`,
    description: `Access ${book.name} NCERT book chapters with solved questions, AI explanations, and practice problems.`,
    keywords: `NCERT ${book.name}, NCERT solutions, ${book.name} solutions, NCERT book online`,
  }
}

export default async function NCERTBookPage({
  params,
}: {
  params: { slug: string }
}) {
